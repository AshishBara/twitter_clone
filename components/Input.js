...
//         space-x-3 overflow-y-scroll ${loading && "opacity-60"}`}>
//             <img src="https://www.prsu.ac.in/backend/web/theme/images/avatars/profile-pic.jpg" alt=""
...
//                     className="bg-transparent outline-none text-gray-100 text-lg
...
//                          items-center justify-center top-1 left-1 cursor-pointer" onClick={() => setSelectiveFile(null)}>
